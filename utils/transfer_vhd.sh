...
resourceGroupName=agridatacomputestorage
...
storageAccountName=agridatacomputekorea

# Name of the storage container where the downloaded snapshot will be stored
storageContainerName=images

# Provide the key of the storage account where you want to copy snapshot. 
storageAccountKey=MfrYmE+gmNByV6jHxnbvoBX0MV6BakuEcwmIkcXI/sDW8tP+hXvf1E3k7Bac93OvYt9dkqH3ehUDh99mpEecHw==
